...
@Aspect
@Component 
public class EducationAop {
    Logger logger = LoggerFactory.getLogger(EducationAop.class);

    @Before("execution(* com.example.staffnetwork.service.impl.EducationServiceImpl+.*(..))")
    ...
    @After("execution(* com.example.staffnetwork.service.impl.EducationServiceImpl+.*(..))")
    public void after(JoinPoint joinPoint){
        logger.info("After - "+joinPoint.getTarget().getClass());
        logger.info("After - "+joinPoint.getSignature().getName());
    }

    @AfterReturning(value = "execution(* com.example.staffnetwork.service.impl.EducationServiceImpl+.*(..))",returning = "result")
    ...
    @AfterThrowing(value = "execution(* com.example.staffnetwork.service.impl.EducationServiceImpl+.*(..))",throwing = "ex")
